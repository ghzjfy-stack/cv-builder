(function (global) {
    ...
    function createSectionEditor(config) {
        ...
        function addItem(e) {
            if (e && e.__qcSectionAdded) return false;
            if (e) e.__qcSectionAdded = true;
            if (e && typeof e.preventDefault === 'function') e.preventDefault();
    ...
    if (!document.documentElement.dataset.qcSectionAdd) {
        ...
        document.addEventListener('click', function (e) {
            ...
            else if (btn.id === 'btn-add-experience' && global.QCExperience && typeof QCExperience.addJob === 'function') {
                QCExperience.addJob(e);
            }
        }, true);
    }
