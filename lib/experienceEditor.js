(function (global) {
    ...
    function bindAddButton() {
        ...
        // Single handler only — avoid multi-binding races with __qcJobHandled.
    ...
    function bindDocumentAdd() {
        ...
        document.addEventListener('click', function (e) {
            ...
            if (!btn) return;
            // Prefer the button's own listener; only catch when that binding is missing.
            if (btn.dataset && btn.dataset.qcAddBound === '1') return;
            if (e && typeof e.preventDefault === 'function') e.preventDefault();
            addExperience(e);
        }, true);
    }
