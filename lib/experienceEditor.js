(function (global) {
    var copy = {
        he: {
            ...
            rawHint: 'כל משרה בבלוק נפרד. שורה ראשונה: תקופה | תפקיד. שורה שנייה: חברה. שורות הבאות: נקודות.',
            save: 'שמירה',
            cancel: 'ביטול'
        },
        en: {
            ...
            rawHint: 'One job per block. First line: Dates | Title. Second line: Company. Following lines: bullets.',
            save: 'Save',
            cancel: 'Cancel'
        }
    };
    ...
    function trashSvg() {
        return '<svg viewBox="0 0 24 24" aria-hidden="true" width="18" height="18"><path fill="currentColor" d="M9 3h6l1 2h5v2H3V5h5l1-2zm1 6h2v10h-2V9zm4 0h2v10h-2V9zM7 9h2v10H7V9zm-1 12h12a1 1 0 0 0 1-1V8H5v12a1 1 0 0 0 1 1z"/></svg>';
    }
