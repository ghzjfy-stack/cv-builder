(function (global) {
    ...
    function addExperience(e) {
        ...
        // React FormDataContext may call us after already updating QCCvData — skip duplicate append.
        ...
        if (evt) {
            if (evt.__qcJobHandled) return false;
        ...
        try {
            ...
            // Immutable append into the main form state (QCCvData.experience via publishExperience).
            var newJob = normalizeJob({
    ...
    function onAddExperienceClick(e) {
        ...
        // Do not stopPropagation here — keep HTML onclick + capture both able to run;
        // addExperience guards with __qcJobHandled so we never double-add.
    ...
    function bindAddButton() {
        ...
        // Keep both property and attribute so the button stays live after any DOM churn.
    ...
    function bindDocumentAdd() {
        ...
        document.addEventListener('click', function (e) {
            ...
            var btn = t.closest('#btn-add-experience');
            if (!btn) return;
