(function (global) {
    ...
    var HEADER_MAP = [
        ...
        { key: 'experience', re: /^(work\s+experience|experience|employment|ניסיון( תעסוקתי| מקצועי)?)$/i },
        { key: 'education', re: /^(education|השכלה( וקורסים| אקדמית)?)$/i },
        { key: 'military', re: /^(military|national service|שירות( צבאי| לאומי)?)$/i },
        { key: 'skills', re: /^(skills|כישורים( מקצועיים)?|יכולות)$/i },
