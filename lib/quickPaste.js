(function (global) {
    ...
    var HEADER_MAP = [
        { key: 'summary', re: /^(professional\s+summary|summary|profile|about(\s+me)?|תקציר( מקצועי)?|אודות|פרופיל)$/i },
        { key: 'experience', re: /^(work\s+experience|professional\s+experience|experience|employment|ניסיון( תעסוקתי| מקצועי)?)$/i },
        { key: 'education', re: /^(education(\s+and\s+courses)?|השכלה( וקורסים| אקדמית)?|קורסים)$/i },
    ...
    var INLINE_HEADERS = [
        ...
        'תקציר מקצועי', 'ניסיון תעסוקתי', 'ניסיון מקצועי', 'השכלה וקורסים', 'השכלה אקדמית',
        'שירות צבאי', 'שירות לאומי', 'פרטים אישיים', 'כישורים מקצועיים',
        'employment', 'education', 'experience', 'references', 'languages', 'military',
        'summary', 'profile', 'skills', 'contact', 'about',
        'תקציר', 'השכלה', 'כישורים', 'המלצות', 'שפות', 'אודות', 'פרופיל', 'יכולות', 'קורסים'
    ];
