(function (global) {
    ...
    function isOpener(el) {
        ...
        var id = el.id;
        return id === 'btn-sample-pdf-studio' || id === 'btn-sample-pdf-home' || id === 'btn-sample-pdf-form';
    }

    function bind() {
        if (document.documentElement.__qcSampleBound) {
            document.querySelectorAll('[data-sample-pdf-opener], #btn-sample-pdf-studio, #btn-sample-pdf-home, #btn-sample-pdf-form').forEach(function (btn) {
        ...
        document.addEventListener('click', function (e) {
            var btn = e.target && e.target.closest && e.target.closest('[data-sample-pdf-opener], #btn-sample-pdf-studio, #btn-sample-pdf-home, #btn-sample-pdf-form');
