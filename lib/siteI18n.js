...
(function (global) {
    var EXTRA = {
        he: {
            ...
            homeLead: 'ממלאים פרטים, בוחרים עיצוב נקי ומורידים קובץ PDF מוכן להגשה. תשלום חד-פעמי של 10 ₪ בלבד המקנה גישה חופשית לעריכה והורדות ל-24 שעות – ללא הרשמה וללא מנוי מוסתר.',
            homeCta: 'צרו קורות חיים ב-10 ₪',
            ...
            payTimerLabel: 'זמן גישה שנותר',
            payTimerSub: 'עריכה והורדה חופשית לכל התבניות',
            payTimerExpired: 'פג תוקף הגישה',
            payTimerExpiredSub: 'יש לבצע תשלום חדש להורדה',
            studioTimerLabel: 'גישה פעילה',
            ...
            waPreparing: 'מכין לשליחה בוואטסאפ...',
            waDownloadedAttach: 'הקובץ ירד. צרפו אותו בשיחת WhatsApp שנפתחה.',
            waShared: 'בחרו WhatsApp בחלון השיתוף כדי לשלוח את ה-PDF.',
        ...
        en: {
            ...
            homeLead: 'Fill in your details, pick a clean design, and download a submission-ready PDF. One-time payment of only 10 ₪ with free edit and download access for 24 hours — no signup, no hidden subscription.',
            homeCta: 'Create a resume for ₪10',
            ...
            payTimerLabel: 'Access time left',
            payTimerSub: 'Free edit & download for every template',
            payTimerExpired: 'Access expired',
            payTimerExpiredSub: 'A new payment is needed to download',
            studioTimerLabel: 'Access active',
            ...
            waPreparing: 'Preparing WhatsApp share...',
            waDownloadedAttach: 'File downloaded. Attach it in the WhatsApp chat that opened.',
            waShared: 'Choose WhatsApp in the share sheet to send the PDF.',
    ...
    var ID_MAP = {
        ...
        'pay-timer-label': 'payTimerLabel',
        'pay-timer-sub': 'payTimerSub',
        'studio-timer-label': 'studioTimerLabel',
    ...
    function apply(lang) {
        ...
        ['home-lead', 'home-title', 'home-subhead', 'seo-landing-lead', 'seo-landing-title', 'home-cta'].forEach(function (id) {
            var el = document.getElementById(id);
            if (el) el.setAttribute('dir', dir);
        });
