...
(function (global) {
    var EXTRA = {
        he: {
            ...
            paySubDesktop: 'סירקו את הקוד במחשב, או לחצו לפתיחת Bit בנייד.',
            paySubMobile: 'לחצו למעבר מאובטח לתשלום באפליקציית Bit',
            payPhoneLabel: 'מספר טלפון לזיהוי ההעברה',
            payQrCaption: 'סריקה מהמחשב',
            payQrAlt: 'קוד QR לתשלום 10 ₪ ב-Bit',
            payClose: 'סגור תשלום',
            payWait: 'ממתין לאישור תשלום... (ההורדה תתחיל אוטומטית)',
            paySuccess: 'התשלום אושר בהצלחה!',
            paySuccessHint: 'אם ההורדה לא מתחילה אוטומטית ב-Safari, לחצו על הכפתור הירוק.',
            ...
            pdfSpinLead: 'הקובץ יורד למחשב בעוד רגע',
            ...
            waShareText: 'היי, אלה קורות החיים מ-QuickCV. הקובץ ירד למכשיר — צרפו אותו כאן.',
        ...
        en: {
            ...
            paySubDesktop: 'Scan the code on desktop, or tap to open Bit on mobile.',
            paySubMobile: 'Tap for a secure payment in the Bit app',
            payPhoneLabel: 'Phone number to identify the transfer',
            payQrCaption: 'Scan from desktop',
            ...
            paySuccessHint: 'If download does not start automatically in Safari, tap the green button.',
            ...
            pdfSpinLead: 'Your file will download in a moment',
            ...
            waShareText: 'Hi — here is my QuickCV resume. The file downloaded to this device — please attach it here.',
