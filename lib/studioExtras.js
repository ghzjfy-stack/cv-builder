(function (global) {
    ...
    function applyGuaranteeCopy() {
        var copy = 'תשלום חד-פעמי • ללא מנוי • הורדה מיידית';
        ...
        if (formLine) {
            ...
            formLine.textContent = copy;
        }
        document.querySelectorAll('.guarantee-badge, .pay-guarantee, #studio-pay-guarantee, #modal-pay-guarantee').forEach(function (el) {
            if (el.id === 'form-pay-guarantee') return;
            el.textContent = copy;
