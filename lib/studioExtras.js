(function (global) {
    ...
    function applyGuaranteeCopy() {
        var i18n = (global.CV_I18N && global.CV_I18N[global.QCCvLang === 'en' ? 'en' : 'he']) || {};
        var accessCopy = i18n.payGuarantee || 'תשלום חד-פעמי • ללא מנוי וללא התחייבות';
        var microCopy = i18n.payMicrocopy || 'תשלום חד-פעמי • ללא מנוי • הורדה מיידית';
        var dir = global.QCCvLang === 'en' ? 'ltr' : 'rtl';
