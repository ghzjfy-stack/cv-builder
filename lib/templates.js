(function (global) {
    var TEMPLATES = {
        simple: {
            title: 'נקי ומינימליסטי',
            titleHe: 'נקי ומינימליסטי',
        ...
        navy: {
            title: 'עסקי ורשמי',
            titleHe: 'עסקי ורשמי',
            titleEn: 'Business Formal',
            subHe: 'תמר • מנהלת כספים',
            subEn: 'Tamar • Finance Manager',
            thumb: 'lay-navy',
            layout: 'navy',
            skin: '',
            accent: '#12192b',
        ...
        azure: {
            title: 'הייטק וטכנולוגיה',
            titleHe: 'הייטק וטכנולוגיה',
            titleEn: 'High-Tech',
            subHe: 'עידו • מעצב UX/UI',
            subEn: 'Ido • UX/UI Designer',
            thumb: 'lay-azure',
            layout: 'azure',
            skin: '',
            accent: '#3d5a6c',
            ...
            he: {
                ...
                summary: 'מעצב מוצר עם דגש על מחקר, מערכות עיצוב ומסכים נקיים להגשה מקצועית.',
                ...
                military: '2011 - 2013 | מעצב גרפי ביחידה',
        ...
        mint: {
            ...
            titleHe: 'מודרנית',
            titleEn: 'Modern',
            subHe: 'עומר • הצלחת לקוח',
            subEn: 'Omer • Customer Success',
            thumb: 'lay-mint',
            layout: 'azure',
            skin: 'mint',
            accent: '#2f6f6a',
        ...
        blush: {
            ...
            en: {
                ...
                location: 'Ra\'anana',
                linkedin: 'linkedin.com/in/shiraalon',
                summary: 'HR specialist focused on quality hiring, onboarding, and manager support.',
        ...
        slate: {
            ...
            titleEn: 'Full-Stack',
            subHe: 'דניאל • מפתח Full-Stack',
            subEn: 'Daniel • Full-Stack Developer',
            thumb: 'lay-slate',
            layout: 'charcoal',
            skin: 'slate',
            accent: '#3e4c58',
        ...
        terracotta: {
            ...
            subHe: 'אורן לוי · מעצב גרפי',
            subEn: 'Oren Levi · Graphic Designer',
            ...
            he: {
                ...
                title: 'מעצב גרפי',
                phone: '050-3342211',
                email: 'oren.levi@example.com',
                location: 'יפו',
                linkedin: 'linkedin.com/in/orenlevi',
                summary: 'מעצב גרפי למותגים, אריזות ודיגיטל. פריסה חמה וקריאה שמתאימה להגשה יצירתית בלי לאבד בהירות.',
            ...
            en: {
                ...
                location: 'Jaffa',
                linkedin: 'linkedin.com/in/orenlevi',
                summary: 'Graphic designer for brands, packaging, and digital. A warm, readable layout that still looks professional.',
        ...
        cream: {
            title: 'קלאסית מסורתית',
            titleHe: 'קלאסית מסורתית',
            titleEn: 'Traditional Classic',
        ...
        intern: {
            ...
            subHe: 'מאיה • סטודנטית למדעי המחשב',
            subEn: 'Maya Rosen · Computer Science Student',
            thumb: 'lay-intern',
            layout: 'compact',
            skin: '',
            accent: '#3e4c58',
        ...
        petra: {
            title: 'פורמט כרונולוגי',
            titleHe: 'פורמט כרונולוגי',
            titleEn: 'Chronological Format',
            subHe: 'איתי • חשבונאות',
            subEn: 'Itai • Accounting',
            thumb: 'lay-petra',
            layout: 'navy',
            skin: '',
            accent: '#12192b',
            ...
            he: {
                ...
                title: 'רואה חשבון',
                phone: '052-4410190',
                email: 'itai.cohen@example.com',
                location: 'תל אביב',
                linkedin: 'linkedin.com/in/itaicohen',
                summary: 'רואה חשבון עם ניסיון בדוחות כספיים, ציות מס והערכת סיכונים. פורמט כרונולוגי ברור להגשה למשרדי רואי חשבון.',
            ...
            en: {
                ...
                education: '2013 - 2017 | The College of Management\nB.A. Accounting and Finance\n2018 | CPA license',
                military: '',
        ...
        midnight: {
            title: 'ניהול בכיר',
            titleHe: 'ניהול בכיר',
            titleEn: 'Senior Management',
            subHe: 'אלון • סמנכ"ל תפעול',
            subEn: 'Alon • VP Operations',
            thumb: 'lay-midnight',
            layout: 'navy',
            skin: 'midnight',
            accent: '#12192b',
            ...
            he: {
                ...
                summary: 'מנהל תפעול עם ניסיון בהובלת צמיחה, ייעול תהליכים ודיווח להנהלה. עיצוב רשמי להגשה לתפקידי ניהול בכיר.',
        ...
        harvard: {
            title: 'כרונולוגי להגשה',
            titleHe: 'כרונולוגי להגשה',
            titleEn: 'Chronological ATS',
            ...
            he: {
                ...
                summary: 'יועץ עם ניסיון בפרויקטי צמיחה, תמחור ומחקר שוק. פורמט כרונולוגי נקי להגשה במערכות גיוס ולבדיקת עיניים.',
            ...
            en: {
                ...
                location: 'Tel Aviv',
                linkedin: 'linkedin.com/in/noamstern',
                summary: 'Consultant with growth, pricing, and market-research experience. A clean chronological format that reads well in ATS systems and in person.',
        ...
        europass: {
            title: 'פורמט אירופי',
            titleHe: 'פורמט אירופי',
            titleEn: 'European CV',
            subHe: 'מיכל • רכזת פרויקטים',
            subEn: 'Michal • Project Coordinator',
            thumb: 'lay-europass',
            layout: 'azure',
            skin: '',
            accent: '#3d5a6c',
        ...
        cobalt: {
            ...
            titleHe: 'הייטק',
            titleEn: 'High-Tech',
            subHe: 'יובל • מהנדס DevOps',
            subEn: 'Yuval • DevOps Engineer',
            thumb: 'lay-cobalt',
            layout: 'modern',
            skin: '',
            accent: '#3e4c58',
    ...
    Object.keys(TEMPLATES).forEach(function (id) {
        var layout = TEMPLATES[id] && TEMPLATES[id].layout;
        if (layout === 'azure' || layout === 'classic' || layout === 'minimal' || layout === 'compact' || layout === 'modern' || layout === 'executive') {
            delete TEMPLATES[id];
        }
    });
    ORDER = ORDER.filter(function (id) { return TEMPLATES[id]; });
